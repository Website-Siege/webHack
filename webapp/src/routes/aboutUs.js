        ...
        <div className="header">
            ...
            <div className="team bg-dark bg-gradient text-white">
                ...
                <div className='d-flex flew-row flex-wrap flex-grow-1 justify-content-center justify-content-evenly'>
                    <div className='topRow d-flex flex-row flex-wrap flex-grow-1 justify-content-evenly'>
                        <AboutCard memPic={Mj} member={'Mj'} position={'Team Lead'} context={'Second year software engineering'} />
                        <AboutCard memPic={Brandon} member={'Brandon'} position={'Software Dev'} context={'Second year computer engineering'} />
                        <AboutCard memPic={Ben} member={'Ben'} position={'Software Dev'} context={'Second year applied mathematics/CS'} />
                    </div>
                    <div className='botRow d-flex flex-row flex-wrap flex-grow-1 justify-content-evenly'>
                        <AboutCard memPic={Austin} member={'Austin'} position={'Software Dev'} context={'Second year computer engineering'} />
                        <AboutCard memPic={Tyler} member={'Tyler'} position={'Software Dev'} context={'Second year software engineering'} />
                        <AboutCard memPic={Kyle} member={'Kyle'} position={'Software Dev'} context={'First year computer engineering'} />
                    </div>
                </div>
            </div>
            <footer>
